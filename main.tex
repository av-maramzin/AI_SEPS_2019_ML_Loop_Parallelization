...
%%% The following is specific to AI-SEPS '19 and the paper
%%% '“It Looks Like You’re Writing a Parallel Loop”: A Machine Learning Based Parallelization Assistant'
%%% by Aleksandr Maramzin, Christos Vasiladiotis, Roberto Castañeda Lozano, Murray Cole, and Björn Franke.
%%%
...
% in order to eliminate widows and orphans
\clubpenalty = 10000
\widowpenalty = 10000
...
\email{s1736883@sms.ed.ac.uk}
\author{Christos Vasiladiotis}
\affiliation{%
  \institution{The University of Edinburgh}
  \country{United Kingdom}
}
\email{c.vasiladiotis@sms.ed.ac.uk}
\author{Roberto Casta\~neda Lozano}
\affiliation{%
  \institution{The University of Edinburgh}
  \country{United Kingdom}
}
\email{roberto.castaneda@ed.ac.uk}
\author{Murray Cole}
\affiliation{%
  \institution{The University of Edinburgh}
  \country{United Kingdom}
...
\copyrightyear{2019}
\acmYear{2019}
\acmConference[AI-SEPS '19]{Proceedings of the 6th ACM SIGPLAN International Workshop on AI-Inspired and Empirical Methods for Software Engineering on Parallel Computing Systems}{October 22, 2019}{Athens, Greece}
\acmBooktitle{Proceedings of the 6th ACM SIGPLAN International Workshop on AI-Inspired and Empirical Methods for Software Engineering on Parallel Computing Systems (AI-SEPS '19), October 22, 2019, Athens, Greece}
\acmPrice{15.00}
\acmDOI{10.1145/3358500.3361567}
\acmISBN{978-1-4503-6983-1/19/10}
...
\begin{figure}[ht]
\includegraphics[width=0.48\textwidth]{figures/LOOCV_accuracy.pdf}
